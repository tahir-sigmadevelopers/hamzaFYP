                ...
                <div className="mt-4 sm:mx-auto sm:w-full sm:max-w-sm">
                    <form onSubmit={addPropertySubmit} className="space-y-1" encType="multipart/form-data">
                        ...
                        <div>
                            ...
                            <div className="mt-2">
                                <textarea name="description" rows="4" class="w-full text-sm text-gray-900 bg-white   focus:ring-0  border p-1 border-black rounded-sm" placeholder="Write Property Description..." value={description} onChange={(e) => setDescription(e.target.value)}></textarea>
